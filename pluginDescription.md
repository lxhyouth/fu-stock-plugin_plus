...
1. Real-time quote inquiry for A-share (Shanghai/Shenzhen), Hong Kong and US stocks (price, change percentage, volume, turnover rate).
...
## 中文介绍
【FuTrade】一站式 A 股/港股/美股行情监控与收益管理工具，专为 IDEA 开发者打造：
- 支持 A 股（沪/深）、港股、美股全市场标的实时行情查询（股价、涨跌幅、成交量等）；
