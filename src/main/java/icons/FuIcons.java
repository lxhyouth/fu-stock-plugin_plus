...
public interface FuIcons {
    ...
    Icon FU_ADD_GROUP = IconLoader.getIcon("icon/addDirectory.svg", FuIcons.class);
    ...
    Icon FU_STOCK_HOLD_GROUP = IconLoader.getIcon("icon/stock_hold.svg", FuIcons.class);
    Icon FU_TIP = IconLoader.getIcon("icon/tip.svg", FuIcons.class);
}
